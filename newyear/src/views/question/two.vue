<template>
  <div class="common-pages que-one" >
    ...
    <div class="reply-box">
      ...
      <div class="up-btn common-btn" btn @click="submitFn" >立即提交</div>
    </div>
    ...
    <div class="layer layer-up" v-show="layerShow == 'ok'">
      ...
      <router-link to="/question/three" class="close-btn common-btn" btn  >下一题</router-link>
    </div>
  </div>
</template>
...
.layer-ok{
  ...
  .iconfont{
    text-align: center; 
    margin:0 auto; line-height: 1; font-size: size(60); margin-bottom: size(23);
    color:#FA5151;
  }
  .info{
    text-align: center;
    font-size: size(20); margin-bottom: size(38);
    color:#000;
  }
  .close-btn{
    margin:0 auto 0;
...
.layer-up{
  box-sizing: border-box;
  width:size(326); height:size(292); padding-top: size(55);
  .iconfont{
    text-align: center; 
    margin:0 auto; line-height: 1; font-size: size(50); margin-bottom: size(18);
    color:#07C160;
  }
  .info{
    text-align: center;
