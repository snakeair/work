  ...
  <div class="reg-pages">
    ...
    <div class="form-box" >
      ...
      <div class="pact">
        ...
        我已阅读并同意<router-link to="/pact/reg" >《趣融分期注册协议》</router-link>
      </div>
    ...
    <!--验证码--->
    <div class="layer layer-mobile"  v-show="layerShow == 'codeShow'">
      <h1 class="layer-title"><em class="icon"><img class="img" src="@/assets/images/img-09.png" alt=""></em>短信验证码已发送至182****9592</h1>
      <div class="code-form">
        ...
        <p class="error" v-show="codeErr" >验证码错误</p>
      </div>
      <div class="form-btn" @click="regFn" >下一步</div>
...
.reg-pages{
  ...
  .form-box{
    box-sizing: border-box;
    width: size(690); margin:0 auto 0; padding-right: size(30); padding-left: size(30); padding-top: size(40); margin-top: size(30); padding-bottom: size(30); margin-bottom: size(50); border-radius: 10px;
